...
import searchNews from '../store/actions/searchNews'
    ...
    return (
        <>
            <form className="news_search" onSubmit={submitHandler}>
                <input type="text" value={searchVal} onChange={changeHandler} required />
                <button type="submit" className="black_btn">Search</button>
            </form>
        </>
    )
};
